...
const SingleProduct = () => {
  ...
  // This handles cases where selectedProductDetails might be an array or a direct object.
  const product = Array.isArray(selectedProductDetails)
    ? selectedProductDetails[0] // If it's an array, take the first item
    : selectedProductDetails; // Otherwise, assume it's the product object itself
